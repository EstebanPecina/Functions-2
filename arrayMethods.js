...
// CODE HERE
const totals = orders.map((ele) => {
  console.log(ele.price * (1 + ele.tax)) //+1 making it to a percentage
})
...
// CODE HERE
const bobsTotal = purchases.filter((purchase) => purchase.owner === 'Bob').reduce((acc,curr) => acc + curr.price, 0)//getting all of bobs purchases { 
